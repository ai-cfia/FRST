				...
				if ($("#selectProject1").val() != "-1" || $("#selectProject2").val() != "-1") {
					...
					if ($("#selectProject1").val() != "-1") {
						...
						for (let i = 0; i < project1.complexityRisk._cost.length; i++) {
							project1Factor1 += parseFloat(project1.complexityRisk._cost[i]);
						}
						...
						for (let i = 0; i < project1.complexityRisk._scope.length; i++) {
							project1Factor2 += parseFloat(project1.complexityRisk._scope[i]);
						}
						...
						for (let i = 0; i < project1.complexityRisk._communications.length; i++) {
							project1Factor3 += parseFloat(project1.complexityRisk._communications[i]);
						}
						...
						for (let i = 0; i < project1.complexityRisk._projectIntegrationManagement.length; i++) {
							project1Factor4 += parseFloat(project1.complexityRisk._projectIntegrationManagement[i]);
						}
						...
						for (let i = 0; i < project1.complexityRisk._time.length; i++) {
							project1Factor5 += parseFloat(project1.complexityRisk._time[i]);
						}
						project1Factor5 = project1Factor5 / project1.complexityRisk._time.length;

						let project1Factor6 = 0;
						for (let i = 0; i < project1.complexityRisk._communications.length; i++) {
							project1Factor6 += parseFloat(project1.complexityRisk._communications[i]);
						}
						...
						for (let i = 0; i < project1.complexityRisk._procurement.length; i++) {
							project1Factor7 += parseFloat(project1.complexityRisk._procurement[i]);
						}
						...
						for (let i = 0; i < project1.complexityRisk._humanResources.length; i++) {
							project1Factor8 += parseFloat(project1.complexityRisk._humanResources[i]);
						}
						...
						*/
						...
						//let project1CostPhase1 = -(parseFloat(project1.costRelease.fteNumberCostPhase1) * 100000 + parseFloat(project1.costRelease.operatingMoneyCostPhase1));
						...
						//let project1CostPhase2 = -(parseFloat(project1.costRelease.fteNumberCostPhase2) * 100000 + parseFloat(project1.costRelease.operatingMoneyCostPhase2));
						...
						//let project1CostPhase3 = -(parseFloat(project1.costRelease.fteNumberCostPhase3) * 100000 + parseFloat(project1.costRelease.operatingMoneyCostPhase3));
					...
					if ($("#selectProject2").val() != "-1") {
						...
						for (let i = 0; i < project2.complexityRisk._cost.length; i++) {
							project2Factor1 += parseFloat(project2.complexityRisk._cost[i]);
						}
						...
						for (let i = 0; i < project2.complexityRisk._scope.length; i++) {
							project2Factor2 += parseFloat(project2.complexityRisk._scope[i]);
						}
						...
						for (let i = 0; i < project2.complexityRisk._communications.length; i++) {
							project2Factor3 += parseFloat(project2.complexityRisk._communications[i]);
						}
						...
						for (let i = 0; i < project2.complexityRisk._projectIntegrationManagement.length; i++) {
							project2Factor4 += parseFloat(project2.complexityRisk._projectIntegrationManagement[i]);
						}
						...
						for (let i = 0; i < project2.complexityRisk._time.length; i++) {
							project2Factor5 += parseFloat(project2.complexityRisk._time[i]);
						}
						project2Factor5 = project2Factor5 / project2.complexityRisk._time.length;

						let project2Factor6 = 0;
						for (let i = 0; i < project2.complexityRisk._communications.length; i++) {
							project2Factor6 += parseFloat(project2.complexityRisk._communications[i]);
						}
						...
						for (let i = 0; i < project2.complexityRisk._procurement.length; i++) {
							project2Factor7 += parseFloat(project2.complexityRisk._procurement[i]);
						}
						...
						for (let i = 0; i < project2.complexityRisk._humanResources.length; i++) {
							project2Factor8 += parseFloat(project2.complexityRisk._humanResources[i]);
						}
						...
						*/
						...
						//let project2CostPhase1 = -(parseFloat(project2.costRelease.fteNumberCostPhase1) * 100000 + parseFloat(project2.costRelease.operatingMoneyCostPhase1));
						...
						//let project2CostPhase2 = -(parseFloat(project2.costRelease.fteNumberCostPhase2) * 100000 + parseFloat(project2.costRelease.operatingMoneyCostPhase2));
						...
						//let project2CostPhase3 = -(parseFloat(project2.costRelease.fteNumberCostPhase3) * 100000 + parseFloat(project2.costRelease.operatingMoneyCostPhase3));
